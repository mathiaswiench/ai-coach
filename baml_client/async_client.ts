...
import {Interval, Training, TrainingPlan, Week, ActivityType} from "./types"
...
class BamlStreamClient {
  ...
  TrainingPlanGenerator(
    ...
    try {
      ...
      return new BamlStream<RecursivePartialNull<TrainingPlan>, TrainingPlan>(
        raw,
        (a): a is RecursivePartialNull<TrainingPlan> => a,
        (a): a is TrainingPlan => a,
        this.ctx_manager.cloneContext(),
        __baml_options__?.tb?.__tb(),
      )
    } catch (error) {
